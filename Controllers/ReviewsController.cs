...
namespace RSWEBBookShop.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(RSWEBBookShopContext context)
        {
            _context = context;
        }
        ...
        {
            var rSWEBBookShopContext = _context.Review.Include(r => r.Book);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RSWEBBookShopContext.Review'  is null.");
            }
            var review = await _context.Review.FindAsync(id);
            if (review != null)
            {
